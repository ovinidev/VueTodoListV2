...
declare global {
  ...
  > = N1 extends keyof LocalComponents
    ? N1 extends N0
      ? Pick<LocalComponents, N0 extends keyof LocalComponents ? N0 : never>
          ...
          : N1 extends keyof __VLS_GlobalComponents
            ? N1 extends N0
              ? Pick<
                  ...
                  N0 extends keyof __VLS_GlobalComponents ? N0 : never
                >
  ...
  type __VLS_ResolveDirectives<T> = {
    [K in Exclude<keyof T, keyof __VLS_GlobalDirectives> &
      string as `v${Capitalize<K>}`]: T[K]
  }
